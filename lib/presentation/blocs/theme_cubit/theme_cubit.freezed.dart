...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeState&&(identical(other.themeMode, _this.themeMode) || other.themeMode == _this.themeMode));
}
...
int get hashCode {
  final _this = this as ThemeState;
  return Object.hash(runtimeType,_this.themeMode);
}

@override
String toString() {
  final _this = this as ThemeState;
  return 'ThemeState(themeMode: ${_this.themeMode})';
}
